    ...
    <div>
      ...
      <div className="container flex items-center justify-between m-auto ">
        ...
        <button className=" lg:hidden group">
          ...
          <div className="absolute top-0 w-8/12 h-screen ml-auto mr-auto text-white transition-all duration-500 bg-black opacity-0 md:w-5/12 right-full group-focus:right-0 group-focus:opacity-100">
