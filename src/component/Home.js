    ...
    <Zoom>{/*Using Zoom Effect*/}
        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="p-4 mr-auto place-self-center lg:col-span-7">
            ...
            <a href="/" className="inline-flex items-center justify-center px-5 py-3 md:border-2 rounded-tl-[206.22px] rounded-br-[206px] text-base font-medium text-center text-white bg-indigo-500 ">
              Nos Services           </a>
          </div>
