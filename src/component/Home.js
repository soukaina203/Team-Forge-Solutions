...
<div className='grid max-w-screen-xl px-4 py-8 mx-auto place-content-center lg:gap-8 xl:gap-0 lg:py-16 md:grid-cols-12 lg:grid-cols-12'> 



      <div className='mr-auto place-self-center md:col-span-7 '>
        <h1 className=' font-bold  mt-[1rem] 
        text-transparent md:text-left text-3xl lg:text-4xl bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500'> Cohésion, Création, Conquête
          C'est L'action de
          TF-SOL </h1>
...
focus:outline-none focus:ring-[#24292F]/50  rounded-lg text-md px-5 py-2 text-center
 ...
 bg-indigo-500 hover:bg-indigo-800 hidden md:block">
      ...
      <div className='hidden lg:mt-0 md:col-span-5 md:flex  md: mt-[1rem]'>
