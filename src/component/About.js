    ...
    <Zoom>
      <div id="about" className="flex flex-col h-full mt-[5rem] lg:p-[3rem]">
        <div className="flex items-center justify-center w-full">
          {/* First div */}
          <div className="flex-grow max-w-3xl text-[15px] z-40 p-7 bg-purple-200">
            ...
            <p className="md:text-[23px] w-full max-w-2xl mb-8 text-gray-600 mt-2">
          ...
          {/* Image Section */}
          <div className="flex items-end justify-center w-[34rem] h-[25rem] ml-8">
